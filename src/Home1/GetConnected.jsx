...
export default function GetConnexted() {
  ...
  return (
    <div className=" relative w-3/4 mx-auto overflow-hidden rounded-[3rem] bg-black text-white  flex flex-col md:flex-col items-center justify-center">
      ...
      <div className="absolute top-4 w-full md:w-1/2 md:top-32">
        ...
        <div className="flex flex-col sm:flex-row w-full gap-3">
          <input
            ...
            className="flex-grow p-4 rounded-lg bg-neutral-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-yellow-300"
            value={email}
      ...
      <div className="bg-black w-full ">
        <img src={mill} alt="Mill" className="object-cover w-full " />
      </div>
    </div>
  );
}
